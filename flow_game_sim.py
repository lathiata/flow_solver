...
def test3():
	...
	print(fg.get_start_state())
	print('flow game search v0')
	result1 = flow_game_search(fg, TransitionModels.VERSION_0, True)
	print(result1)
	print('flow game search v1')
	result = flow_game_search(fg, TransitionModels.VERSION_1)
	print(result)
...
def test4():
	...
	print(fg.get_start_state())
	print('flow game search v1')
	result = flow_game_search(fg, TransitionModels.VERSION_1, True)
	print(result)
	print('flow game search v0')
	result1 = flow_game_search(fg, TransitionModels.VERSION_0)
	print(result1)
